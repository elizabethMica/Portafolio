...
const About = () => {
  ...
  return (
    <div className=' flex flex-col justify-center items-center px-20 h-full bg-[#252525]' >

        <div  className=' flex flex-col justify-evenly pt-20 border-b-2 border-gray-300'>
        <div className=' flex flex-col justify-center sm:items-start items-center pt-2 pb-2'>
        ...
        <div className=' flex flex-col py-10 '>
            <span className='font-bold font-sansBold text-center text-xl sm:text-2xl text-[#4199999f]'>"Anyone who has never made a mistake; <br/> has never tried anything new"</span>
